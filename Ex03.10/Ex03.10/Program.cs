...
namespace Ex03._10
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            newExam.setSubject(newExam.getSubject());
            newExam.setLevel(newExam.getLevel());
            newExam.setPercentage(newExam.getPercentage());

            newExam.getGrade();
            newExam.getPoints();

            Console.WriteLine("\n Your grade:" + newExam.getGrade() + "\n Your points:" + newExam.getPoints());
