...
namespace TicTacToe
{
    public partial class Form1 : Form
    {
        ...
        public int player = 2;   // If even, X takes their turn, If odd, O takes their turn.
        public int turns = 0;   // how many turns have passed
        public int s1 = 0;     //contains number of wins for player 1, s2 for player 2 and sd for draws
        public int s2 = 0;
        public int sd = 0;
        ...
        {
            XWin.Text = "Total X Wins: " + s1;
            OWin.Text = "Total O Wins: " + s2;
            Draws.Text = "Total Draws: " + sd;
        }
